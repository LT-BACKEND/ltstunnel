...
wget -q -O https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/system/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
RANDOMDOMAIN="https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/system/"
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
curl "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/installer/instal-sshws.sh" | bash

#exp
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/system/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/system/notramcpu" && chmod +x /usr/bin/notramcpu
...
curl "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/installer/install-xray.sh" | bash
sleep 1

curl "https://raw.githubusercontent.com/LT-BACKEND/stunnelvpn/installer/install-paket.sh" | bash
sleep 1
#install slowdns
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
mkdir /root/akun/noobzvpn
mkdir /root/akun/sstp
...
curl "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/installer/install-ipsec.sh" | bash

echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install OPENVPN             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"

wget "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/cfg/vpn.sh" && bash vpn.sh && rm vpn.sh
clear

...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/cfg/password.txt"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/cfg/nginx.conf"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/cfg/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/cfg/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/cfg/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/cfg/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
...
wget https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/scurity/rules.zip
unzip rules.zip
...
wget -q -O /etc/cyber.site "https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/issue.net"
...
wget https://raw.githubusercontent.com/LT-BACKEND/ltstunnel/main/installer/install-bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
mkdir /etc/cybervpn/limit/shadowsocks
mkdir /etc/cybervpn/limit/noobzvpns
mkdir /etc/cybervpn/limit/sstp
mkdir /etc/cybervpn/limit/l2tp

mkdir /etc/lunatic/vmess/.vmess.db
mkdir /etc/lunatic/vless/.vless.db
mkdir /etc/lunatic/noobzvpns/.noobzvpns.db
mkdir /etc/lunatic/noobzvpns/.shadowsocks.db
mkdir /etc/lunatic/ssh/.ssh.db
...
mkdir /etc/cybervpn/limit/shadowsocks/ip
mkdir /etc/cybervpn/limit/noobzvpns/ip
mkdir /etc/cybervpn/limit/sstp/ip
mkdir /etc/cybervpn/limit/l2tp/ip

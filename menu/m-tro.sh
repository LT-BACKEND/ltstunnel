...
sed -i "/$user/d" /etc/lunatic/.trojan.db
...
function unlock(){
sed -i 's/ UNLOCKED//g' /etc/lunatic/.trojan.db
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
uuid=$(cat /etc/lunatic/trojan/.trojan.db | grep $user | awk '{print $4}')
exp=$(cat /etc/lunatic/trojan/.trojan.db | grep $user | awk '{print $3}')
if [ -z "$uuid" ]; then
...
function recovery(){
sed -i 's/ UNLOCKED//g' /etc/lunatic/trojan/.trojan.db
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
echo ""+
current_date=$(date +%s)
data=( $(grep -E "^#! " "/etc/lunatic/.trojan.db" | cut -d ' ' -f 2 | column -t | sort | uniq ) )
for user in "${data[@]}"
do
expiration_date=$(grep -E "^#! " "/etc/lunatic/.trojan.db" | cut -d ' ' -f 3 | column -t | sort | uniq)
...
uuid=$(cat /etc/lunatic/.trojan.db | grep $user | awk '{print $4}')
exp=$(cat /etc/lunatic/.trojan.db | grep $user | awk '{print $3}')
if [ -z "$uuid" ]; then
echo "Oh tidak, UUID-mu terhapus."
sleep 1
echo "Membuat UUID baru..."
...
echo "#& ${user} ${exp} ${uuid}" >>/etc/lunatic/.trojan.db
systemctl restart xray > /dev/null 2>&1
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
DATADB=$(cat /etc/lunatic/.trojan.db | grep "^#!" | grep -w "${user}" | awk '{print $2}')
if [[ "${DATADB}" != '' ]]; then
sed -i "/\b${user}\b/d" /etc/lunatic/.trojan.db
fi
echo "#& ${user} ${exp} ${uuid}" >>/etc/lunatic/.trojan.db
clear
...
if [ -z $user ]; then
echo -e " Yang Bener aje Ngetik Nya babi! "
sleep 2 ; m-tro
else
rm -f /etc/trojan/$user
...
echo -e "${y}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "\e[32;1m Username     : $user"
echo -e "\e[32;1m New Quota    : $Quota"
echo ""
echo -e "${y}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
read -n 1 -s -r -p "Press any key to back on menu"
